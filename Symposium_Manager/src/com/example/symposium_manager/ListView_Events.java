...
public class ListView_Events extends Activity {
		...
		//Search for Data
		 Lst.setOnItemClickListener(new OnItemClickListener() {
	      	  ...
	      	  public void onItemClick(AdapterView<?> listView, View view,int position, long id) {
	      		...
	      		LayoutInflater factory = LayoutInflater.from(ListView_Events.this);
		    	    ...
		    	    public void onClick(DialogInterface dialog, int choice) {
		    	        switch (choice) {
		    	            case DialogInterface.BUTTON_POSITIVE:
		    	            	// Toast.makeText(getApplicationContext(), "YES "+ UN + "   To:  "+MbNox.toString(), Toast.LENGTH_LONG).show();
		    			    	PushingDataToServer(EIDx,ENamex,Venuex,DTx,Instx,UN);
		    	...
		    	AlertDialog.Builder builder = new AlertDialog.Builder(ListView_Events.this);
		    	builder.setMessage("Are you sure to Apply to this Event " + ENamex + "???")
...
private void getUserDetails(){
    class GetDetails extends AsyncTask<Void,Void,String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(ListView_Events.this,"Fetching Event Details...","Wait...",false,false);
        }
...
private void PushingDataToServer(final String EID, final String EName, final String Venue, final String EDT, final String IUN, final String SUN) {
    class Login extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(ListView_Events.this, "Please Wait...", null, true, true);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.trim().equalsIgnoreCase("suc")){
            	Toast.makeText(ListView_Events.this,"Applied to Event Successfully. Event Name: "+ EName,Toast.LENGTH_LONG).show();
            }else  if(s.trim().equalsIgnoreCase("und")){
            	Toast.makeText(ListView_Events.this,"Duplicate Identity (or) Already Applied...",Toast.LENGTH_LONG).show();
            }                
            else{
