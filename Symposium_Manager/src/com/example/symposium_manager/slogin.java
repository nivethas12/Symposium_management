...
public class slogin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit=(Button) findViewById(R.id.CmdLoginUL);
        Reg=(Button) findViewById(R.id.CmdRegisterUL);
        
        Pwd=(TextView) findViewById(R.id.TxtPasswordUL);
		UN=(TextView) findViewById(R.id.TxtUNUL);

		Reg.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent a=new Intent(slogin.this,stureg.class);
                startActivity(a);
            }
           });
		 ...
		 submit.setOnClickListener(new View.OnClickListener() {
	            public void onClick(View v) {
	                ...
	                if(!alert.trim().equals("")){
	                    AlertDialog.Builder b= new AlertDialog.Builder(slogin.this);
    ...
    private void UserLogin(final String UN, final String Pwd) {
        class Login extends AsyncTask<String, Void, String> {
            ...
            String url = "http://arihant2789.ipage.com/Symposium_Details/sLogin.php";
            WebService web = new WebService(url);

            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(slogin.this, "Please Wait...", null, true, true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                if(s.trim().equalsIgnoreCase("Success")){
                	...
                	Intent i = new Intent(slogin.this,smain.class);
                    ...
                    Toast.makeText(slogin.this,s,Toast.LENGTH_LONG).show();
                }
            }
